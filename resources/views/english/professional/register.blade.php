...
<title>
  Register Professional Account | Deal'N'Buy
</title>
    ...
    <div class="wrapper wrapper--w790">
      <div class="card card-5">
        <div class="card-heading">
          <h2 class="title">
            Sign Up <br> Professional Account
          </h2>
        </div>
        <div class="card-body">
          <form method="POST" action="{{url('/en/register-professional')}}">
            {{ csrf_field() }}
            ...
            <div class="form-row">
              ...
              <div class="value">
                <div class="input-group">
                  <input class="input--style-5" type="text" name="responsible_person" required>
                </div>
              </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="value">
                <div class="input-group">
                  <input class="input--style-5" type="text" name="company_registration_number" required>
                </div>
              </div>
            </div>
            <div class="form-row">
              ...
              <div class="value">
                <div class="input-group">
                  <input class="input--style-5" type="text" name="company_address" required>
                </div>
              </div>
            </div>
            {{-- <div class="form-row m-b-55">
