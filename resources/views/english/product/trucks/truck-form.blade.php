...
<head>
  <meta charset="UTF-8">
  <title>Add New Truck | Deal 'N' Buy</title>
...
<div class="container">  
  <form id="contact" action="" method="post">
    ...
    <fieldset>
      <input placeholder="Truck Name" type="text" tabindex="1" required autofocus>
    ...
    <fieldset>
      <input placeholder="Truck Model" type="text" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
