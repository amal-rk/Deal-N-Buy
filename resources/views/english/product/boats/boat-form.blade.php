...
<head>
  <meta charset="UTF-8">
  <title>Add New Boat | Deal 'N' Buy</title>
...
<div class="container">  
  <form id="contact" action="" method="post">
    ...
    <fieldset>
      <input placeholder="Boat Name" type="text" tabindex="1" required autofocus>
    ...
    <fieldset>
      <input placeholder="Boat Model" type="text" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
