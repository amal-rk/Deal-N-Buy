		...
		<div class="container mb-5" id="head-container">
			<div class="d-flex justify-content-center" id="head-wrapper">
				<h6 id="heading" class="text-white">
					<i class="bi bi-pencil-square"></i> Poster une announce
				</h6>
			</div>
		</div>
				...
				<div class="container col-3 mr-5 p-4">
					<ul class="nav flex-column justify-content-center">
						<li class="nav-item mb-1">
							<a class="nav-link" href="#">Électroménagers</a>
						</li>
						<li class="nav-item mb-1">
							<a class="nav-link" href="#">Électroniques</a>
						</li>
						<li class="nav-item mb-1">
						...
						<ul class="nav nav-pills nav-justified">
							<li class="nav-item mr-1">
								<a href="{{url('/fr/user-registration')}}" class="nav-link">S'inscrire
								</a>
							</li>
							<li class="nav-item">
								<a href="{{url('/fr/user-login')}}" class="nav-link">connexion</a>
							</li>
						</ul>
					</ul>
				</div>
